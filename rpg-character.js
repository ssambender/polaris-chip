...
class RpgCharacter extends SimpleColors {
  ...
  static get properties() {
    return {
      ...
      drip: { type: Boolean, reflect: true },
  ...
  render() {
    ...
    const drip = new URL(`https://raw.githubusercontent.com/ssambender/polaris-chip/a20c4cde8f2f93528abe743777b125b1feafe847/myDrip.svg`,import.meta.url).href;
    return html`
      <div class="wrapper">
        ...
        ${this.drip ? this.renderPiece(drip) : ``}
      </div>
